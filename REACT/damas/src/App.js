...
class App extends Component {
  ...
  //Ficha Roja. Aplicar cuando se modularice "Movimiento de ficha roja" en la función movimiento(){}
  moverArriba() {
  }

  //Ficha Azul. Aplicar cuando se modularice "Movimiento de ficha azul" en la función movimiento(){}
  moverAbajo() {
  }
  ...
  movimiento(e) {
    ...
    if (this.state.fichaSeleccionada) {
      ...
      //si es turno de azul se realiza la lógica y sino se cancela el movimiento
      if (turno == "azul") {
        if (
      ...
      //si es turno de rojo se realiza la lógica y sino se cancela el movimiento
      else if (turno == "rojo") {
        if (
          (parseInt(e[0]) + 1) == (fichaMovida.fila) && (parseInt(e[1]) - 1) == fichaMovida.columna ||
          (parseInt(e[0]) + 1) == fichaMovida.fila && (parseInt(e[1]) + 1) == fichaMovida.columna
  ...
  click(e) {
    ...
    // Si la ficha clicada corresponde con el turno, activamos el movimiento
